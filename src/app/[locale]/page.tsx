    ...
    <main id="main">
      ...
      <section className="hero shell-width">
        ...
        <div className="hero-actions">
          <Link className="button primary" href={`${base}/claude-code`} data-track="explore-claude-code">Explore Claude Code <Icon name="arrow" size={17} /></Link>
      ...
      <section className="notes-section shell-width" id="field-notes">
        ...
        <div className="notes-grid">
          {notes.map((note) => (
            <Link className="note-card" href={`${base}${note.href}`} key={note.index} data-track={`note-${note.index}`}>
      ...
      <section className="command-section">
        <div className="shell-width command-grid">
          <div>
            ...
            <Link className="text-link warm" href={`${base}/claude-code`} data-track="open-field-manual">Open the field manual <Icon name="arrow" size={16} /></Link>
          </div>
