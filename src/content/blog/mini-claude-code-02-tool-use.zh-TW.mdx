...
- **每一個輸出都在 20 KB 的地方截斷。** 過長的工具輸出，是把上下文撐爆的頭號元兇。可以參考 [context engineering](/en/blog/context-engineering-for-coding-agents)——一個 agent 的輪次裡，往往有 84% 的內容是工具觀察結果。要在源頭就截斷。
