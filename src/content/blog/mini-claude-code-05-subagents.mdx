...
This is the pattern behind Anthropic's finding that "token usage explains 80% of the variance in outcome quality." The [context engineering research](/en/blog/context-engineering-for-coding-agents) puts the theory; tonight we put the ~90 lines of code.
