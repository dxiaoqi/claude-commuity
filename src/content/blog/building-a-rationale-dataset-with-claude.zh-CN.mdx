...
关于这套工作流的训练侧内容，看 [从解释中蒸馏推理能力：FDE 给工程师的实战启示](/zh-CN/blog/focused-distillation-from-explanations-for-builders)。如果你想把推理理由采集接进本地开发环境，[Claude Code hooks 完整指南](/zh-CN/blog/claude-code-hooks-complete-guide) 讲了怎么在 Claude 运行时自动触发日志与校验脚本。
