...
これこそが、Anthropic の「トークン使用量は結果の品質分散の 80% を説明する」という発見の背後にあるパターンである。[コンテキストエンジニアリングの研究](/en/blog/context-engineering-for-coding-agents)が理論を提示するのに対し、今夜は約 90 行のコードでそれを実装する。
