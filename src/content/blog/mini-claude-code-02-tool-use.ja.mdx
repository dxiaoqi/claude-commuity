...
- **どの出力も 20 KB でトランケートする。** ツール出力の肥大化はコンテキスト爆発の第 1 原因だ。[context engineering](/ja/blog/context-engineering-for-coding-agents) を参照——エージェントの 1 ターンの 84% はツール観測が占めることも多い。ソースの側でトランケートしよう。
