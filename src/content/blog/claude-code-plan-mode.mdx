...
- [Claude Code hub](/en/claude-code) — map → plan → build → verify  
- [The Complete CLAUDE.md Guide](/en/blog/claude-code-claude-md-complete-guide)  
- [Claude Code Hooks](/en/blog/claude-code-hooks-complete-guide)  
- [Claude Code vs Cursor](/en/blog/claude-code-vs-cursor-comparison)  
- [Claude Code First Week](/en/blog/claude-code-first-week)  
