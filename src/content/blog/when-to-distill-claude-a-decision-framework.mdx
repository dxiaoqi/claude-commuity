...
- [Focused distillation from explanations, for builders](/blog/focused-distillation-from-explanations-for-builders)
- [Building a rationale dataset with Claude](/blog/building-a-rationale-dataset-with-claude)
