...
このワークフローの学習側については、[Focused distillation from explanations for builders](/ja/blog/focused-distillation-from-explanations-for-builders) を参照。推論の根拠収集を開発環境に組み込むなら、[the Claude Code hooks guide](/ja/blog/claude-code-hooks-complete-guide) が Claude 実行中にロギングと検証スクリプトを自動で発火させる方法を解説している。
