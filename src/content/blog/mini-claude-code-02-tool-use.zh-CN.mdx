...
- **每一份输出都在 20 KB 处截断。** 过长的 tool 输出是 context 炸掉的头号元凶。参见 [context engineering](/zh-CN/blog/context-engineering-for-coding-agents)——一个 Agent 的一轮里，84% 常常是 tool 观测。要在源头截断。
