...
Deep dive: [The Complete CLAUDE.md Guide](/blog/claude-code-claude-md-complete-guide).
...
**Field pattern we use:** map → plan → build → verify. Example from a real hub change: three files (two locale pages + dictionaries), link targets forced to existing blog slugs before coding. See [Claude Code Plan Mode](/blog/claude-code-plan-mode).
...
Deep dive: [Claude Code Hooks](/blog/claude-code-hooks-complete-guide).
...
- [Plan mode](/blog/claude-code-plan-mode)  
- [CLAUDE.md guide](/blog/claude-code-claude-md-complete-guide)  
- [Hooks](/blog/claude-code-hooks-complete-guide)  
