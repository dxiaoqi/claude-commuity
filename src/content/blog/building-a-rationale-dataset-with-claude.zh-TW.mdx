...
想更瞭解這個工作流程的訓練端，可看 [從解釋出發的聚焦式蒸餾對開發者的意義](/blog/focused-distillation-from-explanations-for-builders)。如果你要把推理理由蒐集接進開發環境，[Claude Code hooks 指南](/blog/claude-code-hooks-complete-guide) 會逐步說明如何在 Claude 執行時自動觸發記錄與驗證腳本。
