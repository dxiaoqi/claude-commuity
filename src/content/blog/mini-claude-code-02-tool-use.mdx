...
- **Every output is truncated at 20 KB.** Long tool outputs are the #1 cause of context blow-up. See [context engineering](/blog/context-engineering-for-coding-agents) — 84% of an agent's turn is often tool observations. Truncate at the source.
